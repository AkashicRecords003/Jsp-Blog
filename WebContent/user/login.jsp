...
<div class="container">
	...
	<form action="/blog/user?cmd=loginProc" method="POST" class="was-validated">
	  ...
	  <a href="https://kauth.kakao.com/oauth/authorize?client_id=b48a16f033ba4f5c38f1fbdfa3c86b4a&redirect_uri=http://localhost:8000/oauth/kakao?cmd=callback&response_type=code"><img height="38px" src="/blog/image/kakao_login_button.png"></img></a>
	</form>
</div>
